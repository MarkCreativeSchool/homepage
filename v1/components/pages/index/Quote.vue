      ...
      <div class="row align-items-center position-relative">
        <div class="col-md-12">
          <div class="quote-text text-center wow fadeInRight" data-wow-delay="300ms">
            ...
            <h2 class="font-weight-light mb-5 line-height-normal"><span class="color-yellow">技術の進歩</span>を止めることはできません。 できるのはそれに適応することです。</h2>
            <h3 class="color-pink">Mark Creative School</h3>
